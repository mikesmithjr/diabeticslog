...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIViewController *viewController3 = [[MedListViewController alloc] initWithNibName:@"MedListViewController" bundle:nil];
    ...
    self.tabBarController.viewControllers = @[navController, viewController2, navController2, viewController4];
